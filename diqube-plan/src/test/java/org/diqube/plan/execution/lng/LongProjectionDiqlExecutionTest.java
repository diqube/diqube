 ...
 */
package org.diqube.plan.execution.lng;
 ...
 */
@Test
public class LongProjectionDiqlExecutionTest extends AbstractDiqlExecutionTest<Long> {
  ...
  public void simpleProjectionWithoutColumns2Test() throws InterruptedException, ExecutionException {
    ...
    try {
      ...
      String resColName =
          new FunctionBasedColumnNameBuilder().withFunctionName("id").addParameterLiteralLong(1).build();
