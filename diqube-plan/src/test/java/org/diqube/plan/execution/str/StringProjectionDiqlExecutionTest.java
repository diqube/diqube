 ...
 */
package org.diqube.plan.execution.str;
...
import org.diqube.plan.execution.AbstractDiqlExecutionTest;
 ...
 */
@Test
public class StringProjectionDiqlExecutionTest extends AbstractDiqlExecutionTest<String> {
  ...
  public void simpleProjectionTest() throws InterruptedException, ExecutionException {
    ...
    try {
      ...
      String resColName =
          new FunctionBasedColumnNameBuilder().withFunctionName("concat").addParameterColumnName(COL_A)
  ...
  public void simpleProjectionParamsSwitchedTest() throws InterruptedException, ExecutionException {
    ...
    try {
      ...
      String resColName =
          new FunctionBasedColumnNameBuilder().withFunctionName("concat").addParameterLiteralString("a")
    ...
    try {
      ...
      String resColName =
          new FunctionBasedColumnNameBuilder()
              ...
              .addParameterLiteralString("a")
              .addParameterColumnName(
                  new FunctionBasedColumnNameBuilder().withFunctionName("concat").addParameterLiteralString("b")
                      .addParameterLiteralString("c").build()).build();
