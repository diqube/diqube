 ...
 */
@AutoInstatiate
public class FlattenedColumnPageBuilderFactory {
  @Inject
  ...
  public FlattenedColumnPageBuilder createFlattenedColumnPageBuilder() {
    return new FlattenedColumnPageBuilder(flattenDataFactory, columnPageFactory);
  }
}
