...
/**
 * A facade for {@link StringColumnShard} that gathers query statistics.
 *
 * @author Bastian Gloeckle
 */
public class StringColumnShardStatsFacade implements StringColumnShard, ColumnShardStatsFacade {
  private StringColumnShard delegate;

  public StringColumnShardStatsFacade(StringColumnShard delegate, boolean isTempColumn) {
