 ...
 */
@AutoInstatiate
public class QueryInfoJsonResultBuilderFactory {
  ...
  public QueryInfoJsonResultBuilder createBuilder() {
    return new QueryInfoJsonResultBuilder(repeatedColumnNameGenerator, functionBasedColumnNameBuilderFactory);
  }
}
