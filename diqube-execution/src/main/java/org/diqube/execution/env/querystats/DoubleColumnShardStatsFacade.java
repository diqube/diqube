...
/**
 * A facade for {@link DoubleColumnShard} that gathers query statistics.
 *
 * @author Bastian Gloeckle
 */
public class DoubleColumnShardStatsFacade implements DoubleColumnShard, ColumnShardStatsFacade {
  private DoubleColumnShard delegate;

  public DoubleColumnShardStatsFacade(DoubleColumnShard delegate, boolean isTempColumn) {
