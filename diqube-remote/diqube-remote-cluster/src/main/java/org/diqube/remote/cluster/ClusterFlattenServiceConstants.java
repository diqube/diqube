 ...
 */
@DiqubeThriftService( //
    serviceInterface = ClusterFlattenService.Iface.class, //
    clientClass = ClusterFlattenService.Client.class, //
    serviceName = ClusterFlattenServiceConstants.SERVICE_NAME, //
